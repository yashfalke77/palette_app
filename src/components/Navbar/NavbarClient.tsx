...
import exploreIcon from '../../../public/Icons/explore-palette.svg';
import paletteGeneratorIcon from '../../../public/Icons/generate.svg';
import randomGeneratorIcon from '../../../public/Icons/generator.svg';
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Avatar>
                  ...
                  <AvatarFallback>{session?.user?.user_metadata?.email}</AvatarFallback>
                </Avatar>
              </DropdownMenuTrigger>
              <DropdownMenuContent className='w-[4rem] mr-[1rem] font-medium'>
                <DropdownMenuGroup>
                  <DropdownMenuItem>
                    <span>Profile</span>
                  </DropdownMenuItem>
